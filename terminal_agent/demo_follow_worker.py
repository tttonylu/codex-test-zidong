"""Quick verification script for the real follow worker BitBrowser call path."""
...
class MockBitBrowserHandler(BaseHTTPRequestHandler):
    """Mock BitBrowser endpoints used by the follow worker."""
        ...
        if self.path == "/browser/open":
            body = {
                ...
                "data": {
                    ...
                    "ws": "ws://127.0.0.1:53325/devtools/browser/mock-follow",
...
def main() -> None:
    server = ThreadingHTTPServer(("127.0.0.1", 15439), MockBitBrowserHandler)
    ...
    try:
        ...
        execution = registry.execute(
            TaskAssignmentPayload(
                task_id="task-follow-01",
                terminal_id="terminal-follow-01",
                instance_id="browser-follow-01",
                script_name="follow",
                parameters={"target_handle": "target_user"},
                priority=1,
            ),
            terminal_hostname="workstation-follow",
